...
public class AgentForm extends AdminForm {
    ...
    private void EditerActionPerformed(java.awt.event.ActionEvent evt) {
        JOptionPane.showMessageDialog(this,"Impossible de supprimer car vous n'avez pas la permission","Suppression Failed", JOptionPane.ERROR_MESSAGE);
    ...
    private void SupprimerActionPerformed(java.awt.event.ActionEvent evt) {
        JOptionPane.showMessageDialog(this,"Impossible de modifier car vous n'avez pas la permission","Modication Failed", JOptionPane.ERROR_MESSAGE);
    }
